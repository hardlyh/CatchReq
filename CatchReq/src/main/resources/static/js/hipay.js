        ...
        methods: {
            ...
            submitUrl: function () {
                if (this.selectReq.mehtod == 'GET') {
                    this.snedGet2(this.selectReq.targetUrl, this.selectReq.paramMap, this.selectReq.headersMap);
                } else {
                    var params = new URLSearchParams();
                    for (order in this.selectReq.paramMap) {
                        params.append(order, this.selectReq.paramMap[order])
                    }
                    this.sendPost(this.selectReq.targetUrl, params, this.selectReq.headersMap);
                }
            },
            getBaseUrl:function(){
